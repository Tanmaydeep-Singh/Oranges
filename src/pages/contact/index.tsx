    ...
    <div className="min-h-screen bg-white dark:bg-[#0f1116] text-gray-900 dark:text-white flex flex-col md:flex-row transition-colors duration-300 pt-14 md:pt-0">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-transparent focus:ring-2 focus:ring-orange-500 focus:outline-none shadow-sm"
              />
            </div>
            ...
            <button
              ...
              className="w-full py-3 text-white font-medium rounded-lg bg-orange-600 hover:bg-orange-700 transition disabled:opacity-60"
            >
      ...
      <div className="w-full md:w-1/2 p-8 sm:p-12 lg:p-16 flex flex-col justify-center items-center text-center space-y-8">
        <div className="space-y-2">
          <h2 className="text-2xl font-semibold text-orange-600">Reach Us</h2>
          <p className="text-base text-gray-600 dark:text-gray-400">
        ...
        <div className="flex items-center gap-3 text-gray-800 dark:text-gray-300 text-sm">
          ...
          <span>hello@orangeproject.com</span>
        </div>

        <div className="flex gap-6 pt-4 text-gray-500">
          <a href="https://instagram.com/orangeproject" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            <Instagram className="w-5 h-5 hover:text-pink-500 transition" />
          </a>
          <a href="https://twitter.com/orangeproject" target="_blank" rel="noopener noreferrer" aria-label="Twitter">
            <Twitter className="w-5 h-5 hover:text-sky-500 transition" />
          </a>
          <a href="https://linkedin.com/company/orangeproject" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
            <Linkedin className="w-5 h-5 hover:text-blue-600 transition" />
          </a>
        </div>

        <div className="pt-6 text-sm text-gray-500 dark:text-gray-400">
          <p>Orange Project Inc.</p>
          <p>India</p>
        </div>
      </div>
    </div>
